...
class TestJWTTokens:
    def test_create_and_decode_access_token(self):
        from app.core.security import create_access_token, decode_token, TokenType, UserRole
    ...
    def test_email_verify_token(self):
        from app.core.security import create_email_verify_token, decode_token, TokenType
...
class TestUserRole:
    def test_role_hierarchy(self):
        from app.core.security import UserRole, ROLE_HIERARCHY
